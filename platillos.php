...
if (isset($_POST['add_platillo'])) {
    ...
    $conn->query("INSERT INTO platillo (nombre, descripcion, porciones_base, id_categoria)
...
if (isset($_POST['update_platillo'])) {
    ...
    $porciones   = max(1, (int)$_POST['porciones_base']);
    $categoria   = (int)$_POST['categoria'];
    $conn->query("UPDATE platillo
                  SET nombre='$nombre', descripcion='$descripcion', porciones_base=$porciones, id_categoria=$categoria
                  WHERE id_platillo=$id");
}
if (isset($_GET['delete'])) {
    $id = (int)$_GET['delete'];
    $conn->query("DELETE FROM platillo WHERE id_platillo=$id");
}

/* ========= Listas ========= */
/* Todas las categorías, ordenadas por orden y nombre */
$catsRes = $conn->query("
...
if ($search !== '') {
    ...
    $sqlPlat .= " WHERE nombre LIKE '%$searchEsc%' OR descripcion LIKE '%$searchEsc%'";
}
$sqlPlat .= " ORDER BY id_platillo ASC";

$platillos = $conn->query($sqlPlat);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<div class="container">
  ...
  <div class="page-content">
    ...
    <div class="card">
      ...
      <table>
        <thead>
          <tr><th>ID</th><th>Nombre</th><th>Descripción</th><th>Porciones base</th><th>Categoría</th><th>Acción</th></tr>
        </thead>
        <tbody>
